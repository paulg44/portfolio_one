...
export default function handleUserKeyWords(question) {
  ...
  const topics = [
    ...
    {
      keywords: ["api"],
      response: `Paul has worked with APIs like the FA API for live football data and Stripe for payments.`,
    },
    {
      keywords: ["best project", "most impressive project"],
      response: `Paul's standout project is the Shardlow St James FC website, which integrates live match data from the FA API and scrapes Instagram posts.`,
    },
    {
      keywords: ["ai", "machine learning"],
      response: `Paul built "Ivy’s Game," an educational AI-powered game where users copy images, and an AI scores them based on accuracy.`,
    },
    {
    ...
    },
    {
      ...
      response: `Paul is looking for his first tech role. Coming from a background in decorating, he's eager to apply his problem-solving skills to real-world software projects.`,
    },
    {
    ...
    },
    {
      ...
      response: `Paul has strong problem-solving skills. His previous career required troubleshooting unpredictable issues, which translates well into software development.`,
    },
    {
